...
We claim that $\P(M=\infty)=0$. Indeed, note that for $c_l\leq s\leq c_{l+1}$, $\ell(T_s)<(l+1)||\cT_g||$. Therefore, 
...
\begin{corollary}
\begin{enumerate}
    \item The number of complex connected components of $\cD$ has finite expectation.
    \item The number of loops of $\cD$ is a.s. finite.
\end{enumerate}
\end{corollary}
\begin
