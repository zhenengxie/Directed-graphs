...
\begin{lemma}
    ...
    \end{equation*}
    Then using the notation of \cref{prop:measure-change},
    \begin{align*}
        &\left( 
            \Phi(n, \floor{T n^{2/3}}),
            \left(
...
\cref{prop:measure-change} then follows as a direct corollary of \cref{lem:measure-change-no-crit} by noting that
\begin{equation*}
    \left( 
        Y^-(n), Y^+(n)
     \right) =
