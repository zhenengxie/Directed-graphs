...
\begin{equation*}
    ...
    \to \frac{\E[D^- D^+]}{\E[D^-]}
\end{equation*}
almost surely as $n \to \infty$ by the law of large numbers. Thus, the results of Cooper and Frieze suggest the criticality condition to be $\E[D^- D^+] = \E[D^-]$. Our work in the sequel confirms that this is the case. Further the law of $(d^-(W), d^+(W))$ in the limit $n \to \infty$ will converge to that of the degree distribution sized biased by in-degree. This is the law of $\Z$ where
\begin{equation*}
    \P(Z^- = k^-, Z^+ = k^+) = \frac{k^-}{\mu} \P(D^- = k^-, D^+ = k^+).
\end{equation*}
The criticality condition is then equivalent to assuming $\E[Z^+] = 1$.
