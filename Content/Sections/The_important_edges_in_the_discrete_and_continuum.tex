...
We will discuss the different type of edges that we can encounter in the exploration. Recall that by slight abuse of notation, we call the dummy leaf that corresponds to a surplus edge its tail.
