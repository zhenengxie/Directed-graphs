...
\subsubsection{Convergence of the positions of the ancestral surplus edges}
...
\end{proof}
\subsection{We see all large SCCs before time $Tn^{2/3}$ with large probability}
...
\myworries{make notation consistent}
